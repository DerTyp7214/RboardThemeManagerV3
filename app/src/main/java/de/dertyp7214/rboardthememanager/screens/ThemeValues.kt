        ...
        fab.setOnClickListener {
            openInputDialog(R.string.value_prefix) { dialog, value ->
                ...
                val themeXml = { dark: Boolean ->
                    ...
                    |<?xml version="1.0" encoding="utf-8"?>
                    |<resources>
                    |    <style name="Theme${if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) "" else "Overlay"}.RboardThemeManager.Colors_${value}" parent="">
                    ...
                    |        <item name="colorSurfaceContainerHigh">@color/${value}_md_theme_${if (dark) "dark" else "light"}_SurfaceContainerHigh</item>
                    |        <item name="colorSurfaceContainer">@color/${value}_md_theme_${if (dark) "dark" else "light"}_SurfaceContainer</item>
                    |        <item name="colorSurfaceContainerLow">@color/${value}_md_theme_${if (dark) "dark" else "light"}_SurfaceContainerLow</item>
                    |        <item name="colorSurfaceContainerLowest">@color/${value}_md_theme_${if (dark) "dark" else "light"}_SurfaceContainerLowest</item>
                    |    </style>
                    |</resources>
                    """.trimMargin()
                }
